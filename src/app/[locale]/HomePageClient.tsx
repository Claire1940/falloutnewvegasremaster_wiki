...
export default function HomePageClient({
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      {
        "@type": "VideoObject",
        name: "Fallout: New Vegas - Official E3 2010 Trailer",
        description:
          "Official Fallout: New Vegas E3 2010 reveal trailer showcasing the Mojave Wasteland.",
  ...
  return (
    <div className="home-shell min-h-screen bg-background text-foreground">
      ...
      {/* Video Section - 紧跟 Hero 区域，桌面端与 Hero 同宽 */}
