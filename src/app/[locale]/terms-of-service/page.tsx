...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Fallout New Vegas Remaster Wiki",
    description: "Read the Terms of Service for Fallout New Vegas Remaster Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Fallout New Vegas Remaster Wiki",
      description: "Terms and conditions for using Fallout New Vegas Remaster Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Fallout New Vegas Remaster Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Fallout New Vegas Remaster Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Fallout New Vegas Remaster Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Fallout New Vegas Remaster Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Fallout: New Vegas". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Quest walkthroughs and faction guides</li>
              <li>Character build and SPECIAL/perk planning</li>
              <li>Weapons, armor, and equipment guides</li>
              <li>Companion recruitment and personal quest guides</li>
              <li>Hardcore Mode and survival strategies</li>
              <li>Mod recommendations and load order help</li>
            </ul>
            <p>
              <strong>Important:</strong> Fallout New Vegas Remaster Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Fallout: New Vegas. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Fallout New Vegas Remaster Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Fallout: New Vegas. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, FALLOUT NEW VEGAS REMASTER WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Fallout New Vegas Remaster Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@falloutnewvegasremaster.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@falloutnewvegasremaster.wiki</a>
            </p>
            <p>
