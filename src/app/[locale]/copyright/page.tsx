...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Fallout New Vegas Remaster Wiki',
    description: 'Copyright and intellectual property information for Fallout New Vegas Remaster Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Fallout New Vegas Remaster Wiki',
      description: 'Copyright and intellectual property information for Fallout New Vegas Remaster Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Fallout New Vegas Remaster Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Fallout New Vegas Remaster Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Fallout New Vegas Remaster Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Bethesda Softworks</strong> - Creators of the Fallout: New Vegas game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Fallout: New Vegas</strong> - Trademark of the game developers</li>
              <li><strong>Fallout New Vegas Remaster Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Fallout New Vegas Remaster Wiki.
            </p>
            ...
            <p>
              ...
              Fallout New Vegas Remaster Wiki<br />
              Email: <a href="mailto:dmca@falloutnewvegasremaster.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@falloutnewvegasremaster.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Fallout New Vegas Remaster Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Fallout New Vegas Remaster Wiki (falloutnewvegasremaster.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@falloutnewvegasremaster.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@falloutnewvegasremaster.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@falloutnewvegasremaster.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@falloutnewvegasremaster.wiki</a>
            </p>
            <p>
